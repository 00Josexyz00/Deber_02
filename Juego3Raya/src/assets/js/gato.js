...
var turno = 0;//turno de los jugadores
...
function comenzar(){
  ...
  if(jugador1.value==""){
    ...
    if(jugador2.value==""){
      ...
      turno = 1;
      document.getElementById("turnoJugador").innerHTML="Adelande jugador: " + jugador1.value;
    }
  }
}
function colocar(boton){
  //metodo para cambiar el tono de los botones
  if(bandera==true){
